...
<div id="admin_bar">
  ...
  <div id="status">管理员：${sessionScope.login.uName} 登录  &#160;&#160;&#160;&#160; <a href="../util/do_logout.jsp">login out</a></div>
  <div id="channel"> </div>
</div>
...
<div id="main">
  ...
  <div id="opt_area">
    ...
    <form action="indexServlet?namename=addtopic" method="post" onsubmit="return check()">
      <p>         
        <label> 主题名称 </label>
