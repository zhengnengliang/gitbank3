...
<div class="right">
        <div class="location">
            ...
            <span>支付宝交易成功中间表管理页面 >> 支付宝交易成功中间表添加页面</span>
        </div>
        <div class="ItripTradeEndsAdd">
           <%-- <form id="ItripTradeEndsForm" name="ItripTradeEndsForm" method="post" action="${pageContext.request.contextPath }/jsp/ItripTradeEnds.do">
        ...
        <fm:form method="post" modelAttribute="ItripTradeEnds">
    	<div class="">编号：        <fm:input path="id"/>   <br/></div>
    	<div class="">订单编号：        <fm:input path="orderno"/>   <br/></div>
    	<div class="">操作状态：	  	 <fm:input path="flag"/><br/></div>
    	<br/>
...
<%-- <script type="text/javascript" src="${pageContext.request.contextPath }/statics/js/itripTradeEndsadd.js"></script>
 --%>